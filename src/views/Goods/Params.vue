                    ...
                    <el-table :data="manyTabelData" border stripe>
                        ...
                        <el-table-column label="操作">
                            <template #default="scope">
                                <el-button sizi="mini" type="primary" icon="el-icon-edit" @click="showEditDialog(scope.row.attr_id)">编辑</el-button>
                                <el-button sizi="mini" type="danger" icon="el-icon-delete" @click="removeParams(scope.row.attr_id)">删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </el-tab-pane>
...
export default {
    data(){
        return {
            ...
            manyTabelData:[],   //动态参数数据
            onlyTabelData:[],   //静态属性数据
            ...
            editForm:{     //修改参数的数据变淡对象
                attr_name:''
            },
            editFormRules:{
                attr_name:[{required:true,message:'请输入参数名称',trigger:'blur'}]
            },
            inputVisible:false,     //控制文本框的输入显示
